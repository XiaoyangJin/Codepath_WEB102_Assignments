            ...
            <body>
                <main class="main">
                    ...
                    <div class="cards">
                        ...
                        <Card img_source="src/images/DeerIsland.jpg" title='Deer Island' desc='Deer Island, part of the Boston Harbor Islands, is notable for its significant wastewater treatment facility, public recreation areas, and panoramic views of the Boston skyline, blending environmental management with public enjoyment.' link="https://www.bostonharborislands.org/deer-island/" />
                        <Card img_source="src/images/WhiteMount.jpg" title='White Mountain' desc='The White Mountains, located in New Hampshire, are a popular outdoor recreation destination, famous for their rugged peaks, scenic vistas, and extensive network of hiking trails, including parts of the Appalachian Trail.' link="https://www.visitwhitemountains.com/" />
                        <Card img_source="src/images/RevereBeach.jpg" title='Revere Beach' desc='Revere Beach, located just north of Boston, Massachusetts, is the oldest public beach in the United States, known for its wide sandy expanse, scenic views, and cultural events like the annual International Sand Sculpting Festival.' link="https://reverebeach.com/" />
                        <Card img_source="src/images/WaldenPond.jpg" title='Walden Pond' desc='Walden Pond, situated in Concord, Massachusetts, is a historic site famous for its association with the writer Henry David Thoreau, who lived there from 1845 to 1847, and its serene natural setting that continues to attract visitors seeking reflection and outdoor activities.' link="https://www.nps.gov/places/walden-pond-in-the-walden-pond-state-reservation.htm" />
                        <Card img_source="src/images/Capcode.jpg" title='Cape Cod' desc='Cape Cod, often referred to colloquially as "Capcode," is a hook-shaped peninsula in Massachusetts, USA, known for its quaint villages, seafood shacks, lighthouses, pristine beaches, and maritime character, making it a beloved summer destination.' link="https://www.capecodchamber.org/" />
                        <Card img_source="src/images/RhodeIsland.jpg" title='Rhode Island' desc='Rhode Island, the smallest state in the United States, is known for its sandy shores, colonial towns, and as a maritime hub, with a rich history, vibrant cultural scene, and the prestigious Ivy League institution, Brown University, located in its capital, Providence.' link="https://www.visitrhodeisland.com/" />
                        <Card img_source="src/images/Salem.jpg" title='Salem' desc='Salem, located in Massachusetts, is historically renowned for its 1692 witch trials and today attracts visitors with its museums dedicated to witchcraft, colonial architecture, and a vibrant waterfront area, blending historical intrigue with modern tourism.' link="https://www.salem.org/" />
                        <Card img_source="src/images/Gateway.jpg" title='Gateway' desc='Getaway offers secluded tiny cabins nestled in nature, providing a tranquil escape from daily life with minimalist designs that encourage guests to unwind and reconnect with the outdoors.' link="https://getaway.house/?adults=1&kids=0&beds=1&dog=false&location=2&checkIn=2024-03-14" />
